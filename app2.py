...
def load_onnx_session():
    ...
    if "TensorrtExecutionProvider" in available:
        try:
            ...
            # TensorRT provider options are parsed by ONNX Runtime. This Jetson
            # build expects boolean values as "True"/"False", not "1"/"0".
            trt_provider_options = {
                "trt_fp16_enable": "True",           # enable FP16 TensorRT kernels
            ...
            if active != "TensorrtExecutionProvider":
                raise RuntimeError(
                    "ONNX Runtime created the session without TensorRT "
